...
public class BasketItem
{
	...
	public float? TaxAmount { get; init; }
	...
	public float? NetTotal { get; init; }
	...
	public List<ShopDiscount>? Discounts { get; init; }
	...
	public bool? WillBeWaitlisted { get; init; }
	...
	public List<BasketPackageItem>? PackageItems { get; init; }

	/// <summary>
	/// Gets or Sets Validity
	/// </summary>
	[JsonPropertyName("validity")]
	public BasketItemValidity? Validity { get; init; }

	/// <summary>
	/// Gets or Sets OptionBudgets
	/// </summary>
	[JsonPropertyName("option_budgets")]
	public List<BasketItemOptionBudget>? OptionBudgets { get; init; }
}
